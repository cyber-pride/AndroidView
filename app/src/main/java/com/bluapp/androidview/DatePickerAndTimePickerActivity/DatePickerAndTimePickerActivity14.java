...
public class DatePickerAndTimePickerActivity14 extends AppCompatActivity {
    private int hour, minute;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_date_picker_and_time_picker14);
    ...
    public void ShowTimePicker(View view){
        RangeTimePickerDialog tpd = new RangeTimePickerDialog(DatePickerAndTimePickerActivity14.this, new RangeTimePickerDialog.OnTimeSetListener() {
            @Override
