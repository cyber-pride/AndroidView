...
public class RecyclerViewActivity13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recycler_view13);
        ...
        recyclerAdapter = new adapter(RecyclerViewActivity13.this, country);
