...
public class RecyclerViewActivity16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new adapter(RecyclerViewActivity16.this, country);
    ...
    private class adapter extends RecyclerView.Adapter<adapter.myViewHolder> {
        ...
        public adapter.myViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.recyclerview_adapter16, parent, false);
