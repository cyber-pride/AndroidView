...
public class RetrofitActivity17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retrofit17);
    ...
    private void submitData(){
        ...
        progressDialog = new ProgressDialog(RetrofitActivity17.this);
        ...
        Call<PostResponse> call = service.postData(enteredtitle, enteredbody, entereduserid);
        //calling the api
