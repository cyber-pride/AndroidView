...
public class RetrofitActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new adapter(RetrofitActivity5.this, responseList);
        list.addItemDecoration(new DividerItemDecoration(RetrofitActivity5.this, DividerItemDecoration.VERTICAL));
        list.setAdapter(recyclerAdapter);
        fetchData();
    }

    private void fetchData(){
        progressDialog = new ProgressDialog(RetrofitActivity5.this);
