...
public class RoomDatabaseActivity11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new adapter(RoomDatabaseActivity11.this, responseList);
        list.addItemDecoration(new DividerItemDecoration(RoomDatabaseActivity11.this, DividerItemDecoration.VERTICAL));
    ...
    private void readData(){
        ...
        Completable.fromAction(new Action() {
            ...
            public void run() throws Exception {
                repoDao.findRepositoriesForUser(3);
            }
                ...
                .subscribe(new CompletableObserver() {
                    ...
                    public void onComplete() {
                        responseList = repoDao.findRepositoriesForUser(3);
                        recyclerAdapter.setList(responseList);
                    }

                    @Override
                    public void onError(Throwable e) {
                        Toast.makeText(RoomDatabaseActivity11.this, "Empty data",Toast.LENGTH_LONG).show();
                    }
                });
    }
