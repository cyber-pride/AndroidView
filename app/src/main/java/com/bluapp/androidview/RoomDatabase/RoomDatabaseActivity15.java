...
public class RoomDatabaseActivity15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_database15);
        list = (RecyclerView)findViewById(R.id.list);
        userDatabase = UserDatabase.getInstance(this);
        readData();
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        list.setLayoutManager(layoutManager);
        recyclerAdapter = new adapter(RoomDatabaseActivity15.this, responseList);
        list.addItemDecoration(new DividerItemDecoration(RoomDatabaseActivity15.this, DividerItemDecoration.VERTICAL));
            ...
            public void run() throws Exception {
                ...
                .subscribe(new CompletableObserver() {
                    ...
                    public void onError(Throwable e) {
                        Toast.makeText(RoomDatabaseActivity15.this, "Empty data",Toast.LENGTH_LONG).show();
                    }
                });
    }
