...
public class TabLayoutAndViewPagerActivity11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout_and_view_pager11);
    ...
    private void getcurrenttabposition(){
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                Toast.makeText(TabLayoutAndViewPagerActivity11.this,"Tab Position "+String.valueOf(position),Toast.LENGTH_LONG).show();
            }
