...
public class TabLayoutAndViewPagerActivity9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout_and_view_pager9);
    ...
    private void onchangelistener(){
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                Toast.makeText(TabLayoutAndViewPagerActivity9.this,"Tab selcted",Toast.LENGTH_LONG).show();
            }
