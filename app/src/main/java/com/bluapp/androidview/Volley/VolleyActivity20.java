...
public class VolleyActivity20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerAdapter = new adapter(VolleyActivity20.this, responseList);
        list.addItemDecoration(new DividerItemDecoration(VolleyActivity20.this, DividerItemDecoration.VERTICAL));
        list.setAdapter(recyclerAdapter);
        fetchData();
    }

    private void fetchData(){
        progressDialog = new ProgressDialog(VolleyActivity20.this);
        progressDialog.setMessage(getString(R.string.loading));
        progressDialog.setCancelable(false);
        progressDialog.show();
        //Defining api service
        RequestQueue requestQueue = Volley.newRequestQueue(VolleyActivity20.this);
        CustomPriorityRequest jsonArrayRequest = new CustomPriorityRequest(Request.Method.GET, baseUrl, null, new Response.Listener<JSONArray>() {
            @Override
    ...
    public class CustomPriorityRequest extends JsonArrayRequest {
        ...
        public CustomPriorityRequest(int method, String url, JSONArray jsonRequest, Response.Listener<JSONArray> listener, Response.ErrorListener errorListener) {
