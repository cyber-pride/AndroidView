...
public class VolleyActivity8 extends AppCompatActivity {
    ...
    private void submitData(){
        ...
        progressDialog = new ProgressDialog(VolleyActivity8.this);
        progressDialog.setMessage(getString(R.string.loading));
        progressDialog.setCancelable(false);
        progressDialog.show();
        //Defining api service
        RequestQueue requestQueue = Volley.newRequestQueue(VolleyActivity8.this);
